...
import com.atguigu.jdbc.j_dao.CustomDAOImpl;
 ...
 * @Version 1.0
 */
public class CustomDAOImplDBCPTest {

    private com.atguigu.jdbc.j_dao.CustomDAOImpl dao = new CustomDAOImpl();
    ...
    public void testGetCustomerById() {
        Connection conn = null;
        try {
            conn = JDBCUtilsWithDataSource.getConnection2();
